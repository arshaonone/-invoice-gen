...
import { FileCheck, Mail, Lock, Eye, EyeOff, ArrowRight } from 'lucide-react'
      ...
      >
        ...
        <div className="card p-8 shadow-xl dark:shadow-black/30">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type={showPwd ? 'text' : 'password'} id="password" placeholder="••••••••"
            ...
            <button type="submit" id="login-submit" disabled={loading} className="btn-primary w-full justify-center mt-2">
              {loading ? (
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            ...
            <Link href="/register" className="text-brand-500 hover:text-brand-600 font-semibold">Sign up free</Link>
          </p>
        </div>
      </motion.div>
    </div>
